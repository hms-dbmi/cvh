...
![Visualization meatball menu](%CLOUDFRONT_URL%/tutorials/visualization-meatball-menu.png)
...
![New Visualization pop-up window](%CLOUDFRONT_URL%/tutorials/new-visualization-modal.png)
...
![Example Data Sources modal](%CLOUDFRONT_URL%/tutorials/example-data-sources.png)

Three data sources load into the panel.

![Loaded data sources in the Data panel](%CLOUDFRONT_URL%/tutorials/data-sources-panel.png)
...
![Dragging a bigwig file onto the canvas](%CLOUDFRONT_URL%/tutorials/drag-bigwig-track.png)
...
![Bigwig data drawn as a bar track](%CLOUDFRONT_URL%/tutorials/first-track-rendered.png)
...
![Track Templates with Area Chart selected](%CLOUDFRONT_URL%/tutorials/track-templates-area.png)
...
![Visual Mapping panel set to a heatmap encoding](%CLOUDFRONT_URL%/tutorials/visual-mapping-heatmap.png)
...
![Changing the colormap in the Code Editor](%CLOUDFRONT_URL%/tutorials/code-editor-colormap.png)

### Format

Some final styling of this track can be done in the **Format** panel, for example adjusting the height to 40px.

![Format panel with the track height set to 40px](%CLOUDFRONT_URL%/tutorials/format-panel.png)
