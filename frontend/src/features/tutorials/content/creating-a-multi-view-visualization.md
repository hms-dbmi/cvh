...
![Create a New View button below the existing view](%CLOUDFRONT_URL%/tutorials/create-a-new-view.png)
![The empty new view added below the first](%CLOUDFRONT_URL%/tutorials/new-view-dropzone.png)
...
![Thin drop area above an existing track](%CLOUDFRONT_URL%/tutorials/thin-drop-area.png)
...
![Second view zoomed in independently of the first](%CLOUDFRONT_URL%/tutorials/views-not-linked.png)
...
![View Linking panel with VIEW 1 as Source and VIEW 2 as Target](%CLOUDFRONT_URL%/tutorials/view-linking-panel.png)
![The two views zooming and panning in coordination](%CLOUDFRONT_URL%/tutorials/views-linked.png)
...
![Pop-up offering OVERLAY A TRACK for the dropped data source](%CLOUDFRONT_URL%/tutorials/overlay-a-track.png)
...
![Visual Mapping panel with TRACK 1 and TRACK 2 tabs](%CLOUDFRONT_URL%/tutorials/visual-mapping-two-tracks.png)
...
![TRACK 2 tab with the mark set to brush and no y channel](%CLOUDFRONT_URL%/tutorials/overlay-track-2.png)
...
![TRACK 1 tab set to a bar mark with y bound to value](%CLOUDFRONT_URL%/tutorials/overlay-track-1.png)
...
![Finished overview and detail visualization with a working brush](%CLOUDFRONT_URL%/tutorials/brush-linked-overview.png)
